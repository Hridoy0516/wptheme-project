...
class Plugin {
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/service-detali.php' );
		...
		require_once( __DIR__ . '/widgets/feature-item.php' );
		require_once( __DIR__ . '/widgets/faq-list.php' );
		require_once( __DIR__ . '/widgets/skill-list.php' );
		require_once( __DIR__ . '/widgets/team-gallery.php' ); 
		require_once( __DIR__ . '/widgets/team-card.php' ); 
		require_once( __DIR__ . '/widgets/team-detalis.php' ); 
		require_once( __DIR__ . '/widgets/client-list.php' );
	...
	// Widgets Categoreius 
	public function techub_elementor_widget_categories( $elements_manager ) {

		$elements_manager->add_category(
			'techub-cat-widget',
			[
				'title' => esc_html__( 'Techub Core', 'techub_core' ),
				'icon' => 'fa fa-plug',
			]
		);
    ...
    /**
	 * Plugin Fontawsome icon 
	 * register plugin actiok hook and filters
	 */
	...
	public function __construct() {
		...
		// widgets Categorieus 
		add_action( 'elementor/elements/categories_registered',[$this, 'techub_elementor_widget_categories'] );
		// Fontasome icon register 
