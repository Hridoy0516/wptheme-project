...
function techub_footer_copyright(){ 
   ...
   // 404 image section 
   function techub_404(){
      $erro_404= get_theme_mod('404',get_template_directory_uri().'/assets/img/error/error.png');
      ?>
         <img src="<?php echo esc_url($erro_404);?>" alt="<?php echo bloginfo(); ?>">
      <?php 

   }


// techub_topheader_social_section
